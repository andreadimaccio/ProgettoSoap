...
<div class="container"
	...
	<form class="px-4 py-3" action="dispatchergenerale?action=login" method="post">
		<div class="mb-3">
		...
		<div class="mb-3 ">
			<button type="submit" class="btn btn-warning"
				style="background-color: #FDA65D;">Accedi</button>
			<button type="submit" class="btn btn-warning" 
				style="background-color: #FDA65D;"><a href="dispatchergenerale?action=registrazione">Registrati</a></button>
		</div>
	</form>
