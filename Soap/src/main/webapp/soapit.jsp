	...
	<div class="card-header sticky-top bg-warning">
		<div class="titolo_cliccabile">
			<div class="btn-group">
				...
				<p role="button" data-bs-toggle="modal" data-bs-target="#modalsoapit1" style ="display: inline">
					TITOLO SOAPIT
				</p>
			</div>		 
		</div>
		<div class="card-body bg-warning bg-opacity-50">
			...
			<p class="card-text">
		      testo soapit stasasfjmasdkvnaskdnvsadvtesto soapit stasasfjmasdkvnaskdnvsadvtesto soapit stasasfjmasdkvnaskdnvsadvtesto soapit stasasfjmasdkvnaskdnvsadvtesto soapit stasasfjmasdkvnaskdnvsadvtesto soapit stasasfjmasdkv
			</p>
		</div>

		<!-- Modal -->
		<div class="modal fade" id="modalsoapit1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
