...
<% ArrayList<Postit> lista = (ArrayList<Postit>) request.getSession().getAttribute("postitDate"); %>
	...
	<div class="container mt-5">
		...
		<div class="grid ">
			...
			<% for (Postit elemento : lista) { %>
				<div class="card text-dark mb-3 soapit overflow-auto mx-auto my-2 g-col-3 ">
