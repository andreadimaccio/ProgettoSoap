...
<div class="h-50 container-sm" >
<img alt="logo" style="float:right;" class="h-100" src="https://github.com/andreadimaccio/ProgettoSoap/blob/main/img/postit2.png?raw=true">
<p class="text-end py-5">Le tue idee in uno spazio igenicamente organizzato</p>
</div>
